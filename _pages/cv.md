...
**Senior Developer (Contractor) | May 2022 – Jan 2025**
*Technologies: Angular, React, .NET, Azure, Xamarin, DocuSign*
...
### Austal Technology
**Senior Developer (Contractor) | June 2021 – May 2022**
*Technologies: React, .NET Core, Azure*
...
### Wesfarmers Chemicals, Energy and Fertilizer
**Senior Developer (Contractor) | October 2020 – June 2021**
*Technologies: React, TypeScript, .NET Core, Azure, Google Maps*

* Worked on the NuLogic Soil Analysis project using React, TypeScript, Google Maps, .NET Core API, and Azure

### BHP
**Senior Developer (Contractor) | November 2018 – October 2020**
*Technologies: Django, Python, .NET, Angular, ServiceNow, AWS*
...
**Senior Developer/Consultant (Contractor) | January 2016 – June 2016**
*Technologies: .NET*

* Designed mobile applications for WA Police using .NET and implemented backend services

### Connected Systems
**Senior Developer/Consultant | November 2012 – November 2015**
*Technologies: .NET, BizTalk, SharePoint*
...
### iiNet
**DevOps Senior Consultant (Contractor) | August 2012 – January 2013 & August 2013 – September 2015**
*Technologies: Tibco EMS, C#, Perl*

* Worked on mail migration projects and Rumba Billing System using Tibco EMS, C#, and Perl

### Eits Global
**Lead Android Developer | September 2011 – July 2012**
...
### Bunnings
**Analysis Programmer/Senior .NET Developer | 2008 – September 2011**
...
* **OpenAI Australia Stock Exchange Env**: [GitHub Repository](https://github.com/guidebee/asx_gym)
* **Solana NFT Playground**: [Website](https://solananft.guidebee.info)
* **Android NFC Ticketing System**: [Video Demo](https://www.youtube.com/watch?v=yourvideolink)
* **Guidebee Mobile GIS Engine**: [Video Demo](https://www.youtube.com/watch?v=yourvideolink)
* **Guidebee Android Game Engine**: [GitHub Repository](https://github.com/guidebee/AndroidGameEngine)
* **Morse Code Toolkit** on Play Store
* **Mini Computer**: [LinkedIn Post](https://www.linkedin.com/posts/yourpost)
